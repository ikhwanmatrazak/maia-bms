...
class Employee(Base):
    ...
    offer_benefits = Column(Text, nullable=True)
    has_epf = Column(Boolean, nullable=False, default=True, server_default="1")
    has_socso_eis = Column(Boolean, nullable=False, default=True, server_default="1")
    has_income_tax = Column(Boolean, nullable=False, default=True, server_default="1")
