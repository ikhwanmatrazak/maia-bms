    ...
    <div>
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4 gap-4">
          ...
          <Button as={Link} href="/invoices/new" color="primary" className="bg-[#1a1a2e]">
            + New Invoice
          </Button>
        </div>
              ...
              <TableRow key={inv.id}>
                ...
                <TableCell>
                  <div className="flex gap-1 flex-wrap">
                    ...
                    <Button as="a" href={invoicesApi.getPdfUrl(inv.id)} target="_blank" size="sm" variant="flat">PDF</Button>
                  </div>
                </TableCell>
              </TableRow>
            ))}
