...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      { href: "/projects/dashboard", label: "Dashboard", roles: ["admin", "manager"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/hr/performance", label: "Performance", roles: ["admin", "manager"] },
    ],
  },
  {
    label: "General",
    ...
    items: [
      ...
      { href: "/reminders", label: "Reminders", roles: ["admin", "manager"] },
