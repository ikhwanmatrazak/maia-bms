...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      { href: "/clients", label: "Clients", permission: "crm" },
      { href: "/pipeline", label: "Pipeline", permission: "crm" },
    ],
  },
  {
    label: "Sales",
    ...
    items: [
      { href: "/quotations", label: "Quotations", permission: "sales" },
      { href: "/invoices", label: "Invoices", permission: "sales" },
      { href: "/receipts", label: "Receipts", permission: "sales" },
    ],
  },
  {
    label: "Procurement",
    ...
    items: [
      { href: "/products", label: "Products", permission: "procurement" },
      { href: "/purchase-orders", label: "Purchase Orders", permission: "procurement" },
      { href: "/vendors", label: "Vendors", permission: "procurement" },
      { href: "/delivery-orders", label: "Delivery Orders", permission: "procurement" },
    ],
  },
  {
    label: "Finance",
    ...
    items: [
      { href: "/payments", label: "Payments", permission: "finance" },
      { href: "/credit-notes", label: "Credit Notes", permission: "finance" },
      { href: "/expenses", label: "Expenses", permission: "finance" },
      { href: "/bills", label: "Bills (Payable)", permission: "finance" },
      { href: "/reports", label: "Reports", permission: "finance" },
    ],
  },
  {
    label: "Projects",
